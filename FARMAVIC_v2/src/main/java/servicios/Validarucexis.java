...
public class Validarucexis extends Conexion implements Validator{
    
    
    public static boolean valRuc (String ruc){
        try {
            String sql = "SELECT RUCPROV FROM PROVEEDOR WHERE RUCPROV = '"+ ruc +"' ";
